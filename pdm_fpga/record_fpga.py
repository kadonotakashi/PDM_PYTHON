...
radiol0 = tk.Radiobutton( lngth_frame, text ="  64 ", value =  64, variable = lngth)
radiol1 = tk.Radiobutton( lngth_frame, text =" 128 ", value = 128, variable = lngth)
radiol2 = tk.Radiobutton( lngth_frame, text =" 256 ", value = 256, variable = lngth)
radiol3 = tk.Radiobutton( lngth_frame, text =" 512 ", value = 512, variable = lngth)
radiol4 = tk.Radiobutton( lngth_frame, text ="1024 ", value = 1024, variable = lngth)
radiol5 = tk.Radiobutton( lngth_frame, text ="2048 ", value = 2048, variable = lngth)
...
radiog2 = tk.Radiobutton( Gain_frame, text =" x  3.0 ", value = 3, variable = gain)
radiog3 = tk.Radiobutton( Gain_frame, text =" x  4.0 ", value = 4, variable = gain)
radiog4 = tk.Radiobutton( Gain_frame, text =" x  5.0 ", value = 5, variable = gain)
radiog5 = tk.Radiobutton( Gain_frame, text =" x  6.0 ", value = 6, variable = gain)
radiog6 = tk.Radiobutton( Gain_frame, text =" x  7.0 ", value = 7, variable = gain)
