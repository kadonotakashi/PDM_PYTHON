...
lngth = tk.IntVar()
lngth.set(64)
lngth_frame = tk.LabelFrame(root,text = "Record Block")
lngth_frame.grid(column=1,row=3)

radiol0 = tk.Radiobutton( lngth_frame, text ="  64  (   2/4 s)", value =  64, variable = lngth)
radiol1 = tk.Radiobutton( lngth_frame, text =" 128  (   4/8 s)", value = 128, variable = lngth)
radiol2 = tk.Radiobutton( lngth_frame, text =" 256  (  8/16 s)", value = 256, variable = lngth)
radiol3 = tk.Radiobutton( lngth_frame, text =" 512  ( 16/32 s)", value = 512, variable = lngth)
radiol4 = tk.Radiobutton( lngth_frame, text ="1024  ( 32/64 s)", value = 1024, variable = lngth)
radiol5 = tk.Radiobutton( lngth_frame, text ="2048  (64/128 s)", value = 2048, variable = lngth)
...
radiog2 = tk.Radiobutton( Gain_frame, text =" x  4.0 ", value = 3, variable = gain)
radiog3 = tk.Radiobutton( Gain_frame, text =" x  8.0 ", value = 4, variable = gain)
radiog4 = tk.Radiobutton( Gain_frame, text =" x 16.0 ", value = 5, variable = gain)
radiog5 = tk.Radiobutton( Gain_frame, text =" x 32.0 ", value = 6, variable = gain)
radiog6 = tk.Radiobutton( Gain_frame, text =" x 64.0 ", value = 7, variable = gain)
